...
export const AUTHORIZATION_GRANT_REPOSITORY = Symbol(
  "AUTHORIZATION_GRANT_REPOSITORY",
);
export const AUTHORIZATION_METRICS_PORT = Symbol("AUTHORIZATION_METRICS_PORT");
export const AUTHORIZATION_RESOLVER_METRICS_PORT = Symbol(
  "AUTHORIZATION_RESOLVER_METRICS_PORT",
);
export const AUTHORIZATION_SCOPE_RESOLVERS = Symbol(
...
export const AUTHORIZATION_TEMPORARY_GRANT_SOURCE = Symbol(
  "AUTHORIZATION_TEMPORARY_GRANT_SOURCE",
);
/**
 * T10 registers this optional lookup globally.  The AuthorizationModule keeps
 * its safe empty source so it remains independently usable by earlier sprints.
 */
export const AUTHORIZATION_TEMPORARY_GRANT_LOOKUP = Symbol(
  "AUTHORIZATION_TEMPORARY_GRANT_LOOKUP",
);
export const AUTHORIZATION_EMERGENCY_GRANT_SOURCE = Symbol(
...
export interface AuthorizationContext {
  ...
  readonly approvalContext?: Readonly<
...
export type AuthorizationScopeRegistryOutcome =
  "MATCH" | "NO_MATCH" | "UNAVAILABLE" | "ERROR";

export interface AuthorizationScopeResolverRegistryPort {
  resolve(
    input: AuthorizationScopeResolverInput,
  ): Promise<AuthorizationScopeRegistryOutcome>;
}
...
export type AuthorizationResolverLatencyBucket =
  "LT_5_MS" | "LT_25_MS" | "LT_100_MS" | "LT_500_MS" | "GTE_500_MS";
...
export type AuthorizationTemporaryGrantSource =
  AuthorizationAlternateGrantSource;
export type AuthorizationEmergencyGrantSource =
  AuthorizationAlternateGrantSource;
