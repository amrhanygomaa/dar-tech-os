...
const protectedPath = /^\/(?:me(?:\/|$)|employees(?:\/|$)|invitations(?:\/|$)|roles(?:\/|$)|permissions(?:\/|$)|approvals(?:\/|$)|temporary-access(?:\/|$)|emergency-access(?:\/|$)|audit-events(?:\/|$)|security-events(?:\/|$)|admin\/sessions(?:\/|$))/u;
