...
const protectedPath =
  /^\/(?:me(?:\/|$)|employees(?:\/|$)|invitations(?:\/|$)|roles(?:\/|$)|permissions(?:\/|$)|approvals(?:\/|$)|temporary-access(?:\/|$)|audit-events(?:\/|$)|security-events(?:\/|$)|admin\/sessions(?:\/|$))/u;
...
export class AuthorizationRequestMiddleware implements NestMiddleware {
  ...
  private async bind(
    ...
    if (
      ...
      this.sessions.recordCsrfDenied(
        typeof origin === "string" ? "foreign_origin" : "missing_origin",
      );
