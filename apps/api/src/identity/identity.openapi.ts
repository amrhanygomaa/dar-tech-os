...
export const employeeSchema: SchemaObject = {
  ...
  properties: {
    ...
    offboardingInitiatedByEmployeeId: { type: 'string', format: 'uuid', nullable: true },
    offboardingReason: { type: 'string', maxLength: 500, nullable: true },
    offboardingApprovalReference: { type: 'string', format: 'uuid', nullable: true },
    offboardingCleanupStatus: {
      type: 'string',
      enum: ['PENDING', 'INCOMPLETE', 'COMPLETED'],
      nullable: true,
    },
    offboardingCleanupAttemptedAt: dateTime,
    offboardingCleanupCompletedAt: dateTime,
    offboardingCleanupFailureCode: { type: 'string', maxLength: 80, nullable: true },
    offboardingSessionsRevokedCount: { type: 'integer', minimum: 0, nullable: true },
    offboardingRolesEndedCount: { type: 'integer', minimum: 0, nullable: true },
    offboardingTemporaryAccessEndedCount: { type: 'integer', minimum: 0, nullable: true },
    offboardingEmergencyAccessEndedCount: { type: 'integer', minimum: 0, nullable: true },
