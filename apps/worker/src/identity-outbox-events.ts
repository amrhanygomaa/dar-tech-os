...
const eventTypes = [
  ...
  "identity.approval-requested",
  "identity.approval-step-approved",
...
export const IDENTITY_OUTBOX_ROUTES: readonly OutboxRoute[] = eventTypes.map(
  (eventType) => ({
    eventType,
    eventVersion: 1,
    consumerName,
...
export const IDENTITY_OUTBOX_CONSUMERS: readonly OutboxConsumer[] =
  eventTypes.map(
