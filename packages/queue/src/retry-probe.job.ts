...
/** Technical-only handler that deterministically proves retry and terminal failure behavior. */
...
export function createRetryProbeJob(options: CreateRetryProbeJobOptions): EnqueueJobInput {
  return {
